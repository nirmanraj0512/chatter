...
const Sidebar = ({selectedUser,setSelectedUser}) => {
  ...
  return (
    // Here we have written the logic of when it will appaer
    <div className={`bg=[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md-hidden":""}`}>
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
            {/* //This div is for Header part logo and dropdown menu     */}
                <img src={assets.logo} alt='logo' className='max-w-40'/>      
                <div className='relative py-2 group'>
                    <img src={assets.menu_icon} alt='menu_logo' className='max-h-5 cursor-pointer' />
            ...
            {/* //This is the div for search box   */}
        ...
        {/* //This div for user proflie in list with profile name image and online/offline status */}
